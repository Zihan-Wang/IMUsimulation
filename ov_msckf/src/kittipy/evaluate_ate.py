...
'''
Example usage:
python evaluate_ate.py ~/datasets/Kitti/dataset/poses/06_converted.txt \
~/workspace/catkin_imu/src/IMUsimulation/ov_data/sim/imupose.csv --plot kitti_odometry_06_ate
'''
